...
const CommunityEventCard = ({name, category, date, location, time, description, attendees, uniqueId}) => {
  const navigation = useNavigation();

  const handleAboutEvent = () => {
    navigation.navigate("EventCardDetailsScreen", {
      name: name,
      category: category,
      date: date,
      location: location,
      ...
      <View style={styles.infoContainer}>
        ...
        <TouchableOpacity
          ...
          <View style={{ alignItems: "center", justifyContent: "center" }}>
            <Text style={styles.buttonText}>Despre eveniment</Text>
          </View>
        </TouchableOpacity>
          </View>
      </View>
