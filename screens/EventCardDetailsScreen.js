...
export default function EventCardDetailsScreen(){
  ...
  const handleInterested = async () => {
    ...
    try {
        ...
        await userRef.update({
            favoriteEvents: firebase.firestore.FieldValue.arrayUnion(route.params.uniqueId),
        });
        const eventRef = FIREBASE_FIRESTORE.collection("events").doc(route.params.uniqueId);
                ...
                <View>
                    <View style={styles.header} className>
                        ...
                        <View style={styles.categoryContainer}>
                            ...
                            <Text style={styles.category}>{route.params.time}</Text>
                            <Text style={styles.divider}>|</Text>
